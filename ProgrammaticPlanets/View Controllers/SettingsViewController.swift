...
class SettingsViewController: UIViewController {
    ...
    private func setupSubViews() {
        ...
        let doneButtonTrailingContraint = NSLayoutConstraint(item: doneButton,
                                                             attribute: .trailing,
                                                             relatedBy: .equal,
        ...
        NSLayoutConstraint.activate([doneButtonTopConstraint, doneButtonTrailingContraint,switchTopConstraint, switchTrailingConstraint, labelLeadingConstraint,labelCenterYConstraint])
